...
export default function Dashboard() {
  ...
  const monthlyIncomeTotal = useQuery(api.incomes.getMonthlyTotal) || {
    total: 0,
    withholdingTotal: 0,
    netTotal: 0,
  };
  const recentExpenses =
    useQuery(api.expenses.getUserExpenses, { limit: 5 }) || [];
  const recentIncomes =
    useQuery(api.incomes.getUserIncomes, { limit: 5 }) || [];
  ...
  const initIncomeCategories = useMutation(
    api.incomeCategories.initializeIncomeCategories
  );
  const initPaymentMethods = useMutation(
    api.paymentMethods.initializePaymentMethods
  );
  ...
  useEffect(() => {
    ...
    if (currentUser) {
      ...
      initPaymentMethods().catch(() => {});
    }
  }, [currentUser, initCategories, initIncomeCategories, initPaymentMethods]);
      ...
      <div className="px-4 py-6 sm:px-0">
              ...
              <div className="flex items-center">
                ...
                <div className="ml-5 w-0 flex-1">
                  ...
                  <dd className="text-lg font-medium text-gray-900">
                    ¥{monthlyIncomeTotal.total.toLocaleString()}
                  </dd>
                  <dd className="text-xs text-gray-700">
                    手取り: ¥{monthlyIncomeTotal.netTotal.toLocaleString()}
                  </dd>
                </div>
              </div>
            </div>
        ...
        <div className="mt-8 grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-3">
          <Link
            ...
            className="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-green-500 rounded-lg shadow hover:shadow-lg transition-shadow"
          >
            <div>
          ...
          <Link
            ...
            className="relative group bg-white p-6 focus-within:ring-2 focus-within:ring-inset focus-within:ring-blue-500 rounded-lg shadow hover:shadow-lg transition-shadow"
          >
            <div>
